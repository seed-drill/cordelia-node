...
# Zone model: R1 must promote all personal nodes to hot before items flow.
wait_for "r1 has 4 hot peers (b1+p1+p2+p3)" \
    '[ "$(api_get t7-r1 status | jq -r ".peers_hot // 0")" -ge 4 ]' 30
